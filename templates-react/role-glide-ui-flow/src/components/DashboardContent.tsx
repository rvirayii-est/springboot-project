  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Welcome to your dashboard overview</p>
      </div>
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              ...
              <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
                ...
                <p className="font-medium text-sm">Sales Data</p>
              ...
              <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
                ...
                <p className="text-xs text-gray-500">Monitor health</p>
              </button>
            </div>
          </CardContent>
        </Card>
